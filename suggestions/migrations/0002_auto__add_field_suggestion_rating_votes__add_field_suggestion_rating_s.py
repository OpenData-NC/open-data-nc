...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Suggestion.rating_votes'
        db.add_column(u'suggestions_suggestion', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Suggestion.rating_score'
        db.add_column(u'suggestions_suggestion', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.rating_votes'
        db.delete_column(u'suggestions_suggestion', 'rating_votes')

        # Deleting field 'Suggestion.rating_score'
        db.delete_column(u'suggestions_suggestion', 'rating_score')
    ...
    models = {
        ...
        u'suggestions.suggestion': {
            ...
            'resources': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'suggestions'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalog.Resource']"}),
