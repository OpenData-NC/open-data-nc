...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommentWithRating'
        db.create_table(u'comments_commentwithrating', (
        ...
        db.send_create_signal(u'comments', ['CommentWithRating'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CommentWithRating'
        db.delete_table(u'comments_commentwithrating')
    ...
    models = {
        ...
        u'comments.commentwithrating': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'CommentWithRating', '_ormbases': [u'comments.Comment']},
