...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_division', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'catalog', ['Division'])

        # Adding model 'Department'
        db.create_table(u'catalog_department', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('type', self.gf('django.db.models.fields.CharField')(default='state', max_length=40)),
        ))
        db.send_create_signal(u'catalog', ['Department'])

        # Adding M2M table for field divisions on 'Department'
        m2m_table_name = db.shorten_name(u'catalog_department_divisions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('department', models.ForeignKey(orm[u'catalog.department'], null=False)),
            ('division', models.ForeignKey(orm[u'catalog.division'], null=False))
        ))
        db.create_unique(m2m_table_name, ['department_id', 'division_id'])

        # Deleting field 'Resource.division'
        db.delete_column(u'catalog_resource', 'division')

        # Deleting field 'Resource.organization'
        db.delete_column(u'catalog_resource', 'organization')


    def backwards(self, orm):
        # Deleting model 'Division'
        db.delete_table(u'catalog_division')

        # Deleting model 'Department'
        db.delete_table(u'catalog_department')

        # Removing M2M table for field divisions on 'Department'
        db.delete_table(db.shorten_name(u'catalog_department_divisions'))

        # Adding field 'Resource.division'
        db.add_column(u'catalog_resource', 'division',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Resource.organization'
        db.add_column(u'catalog_resource', 'organization',
