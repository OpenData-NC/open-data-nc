...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.department'
        db.add_column(u'catalog_resource', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.Department']),
                      keep_default=False)

        # Adding field 'Resource.division'
        db.add_column(u'catalog_resource', 'division',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Division'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.department'
        db.delete_column(u'catalog_resource', 'department_id')

        # Deleting field 'Resource.division'
        db.delete_column(u'catalog_resource', 'division_id')
