...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.agency_type'
        db.add_column(u'catalog_resource', 'agency_type',
                      self.gf('django.db.models.fields.CharField')(default='state', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.agency_type'
        db.delete_column(u'catalog_resource', 'agency_type')
