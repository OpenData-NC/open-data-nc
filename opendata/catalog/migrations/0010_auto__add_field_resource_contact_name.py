...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.contact_name'
        db.add_column(u'catalog_resource', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.contact_name'
        db.delete_column(u'catalog_resource', 'contact_name')
