...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'County'
        db.create_table(u'catalog_county', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'catalog', ['County'])

        # Adding M2M table for field cities on 'County'
        m2m_table_name = db.shorten_name(u'catalog_county_cities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('county', models.ForeignKey(orm[u'catalog.county'], null=False)),
            ('city', models.ForeignKey(orm[u'catalog.city'], null=False))
        ))
        db.create_unique(m2m_table_name, ['county_id', 'city_id'])
        ...
        m2m_table_name = db.shorten_name(u'catalog_resource_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        # Adding M2M table for field cities on 'Resource'
        m2m_table_name = db.shorten_name(u'catalog_resource_cities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resource', models.ForeignKey(orm[u'catalog.resource'], null=False)),
            ('city', models.ForeignKey(orm[u'catalog.city'], null=False))
        ))
        db.create_unique(m2m_table_name, ['resource_id', 'city_id'])

        # Adding M2M table for field counties on 'Resource'
        m2m_table_name = db.shorten_name(u'catalog_resource_counties')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resource', models.ForeignKey(orm[u'catalog.resource'], null=False)),
            ('county', models.ForeignKey(orm[u'catalog.county'], null=False))
        ))
        db.create_unique(m2m_table_name, ['resource_id', 'county_id'])
        ...
        db.create_table(u'catalog_url', (
            ...
            ('url_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.UrlType'])),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Resource'])),
        ))
        ...
        db.create_table(u'catalog_urlimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Url'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'catalog_county')

        # Removing M2M table for field cities on 'County'
        db.delete_table(db.shorten_name(u'catalog_county_cities'))
        ...
        db.delete_table(db.shorten_name(u'catalog_resource_categories'))

        # Removing M2M table for field data_types on 'Resource'
        db.delete_table(db.shorten_name(u'catalog_resource_data_types'))

        # Removing M2M table for field cities on 'Resource'
        db.delete_table(db.shorten_name(u'catalog_resource_cities'))

        # Removing M2M table for field counties on 'Resource'
        db.delete_table(db.shorten_name(u'catalog_resource_counties'))
