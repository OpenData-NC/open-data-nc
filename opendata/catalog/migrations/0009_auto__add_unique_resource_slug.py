...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Resource', fields ['slug']
        db.create_unique(u'catalog_resource', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Resource', fields ['slug']
        db.delete_unique(u'catalog_resource', ['slug'])
