...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Request.update_frequency'
        db.delete_column(u'requests_request', 'update_frequency')

        # Adding field 'Request.updates'
        db.add_column(u'requests_request', 'updates',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.UpdateFrequency'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Request.update_frequency'
        db.add_column(u'requests_request', 'update_frequency',
                      self.gf('django.db.models.fields.CharField')(default='daily', max_length=16),
                      keep_default=False)

        # Deleting field 'Request.updates'
        db.delete_column(u'requests_request', 'updates_id')
