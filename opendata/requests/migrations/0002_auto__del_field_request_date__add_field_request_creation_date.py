...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'requests_request', 'date')

        # Adding field 'Request.creation_date'
        db.add_column(u'requests_request', 'creation_date',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'requests_request', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 22, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Request.creation_date'
        db.delete_column(u'requests_request', 'creation_date')
