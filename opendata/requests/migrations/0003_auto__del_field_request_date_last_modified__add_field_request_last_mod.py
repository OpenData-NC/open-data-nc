...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Request.date_last_modified'
        db.delete_column(u'requests_request', 'date_last_modified')

        # Adding field 'Request.last_modified'
        db.add_column(u'requests_request', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 22, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Request.date_last_modified'
        db.add_column(u'requests_request', 'date_last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 22, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Request.last_modified'
        db.delete_column(u'requests_request', 'last_modified')
