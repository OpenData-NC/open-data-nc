...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Request.contact_phone'
        db.delete_column(u'requests_request', 'contact_phone')

        # Deleting field 'Request.contact_email'
        db.delete_column(u'requests_request', 'contact_email')

        # Deleting field 'Request.contact_url'
        db.delete_column(u'requests_request', 'contact_url')
    ...
    models = {
        ...
        u'catalog.county': {
            ...
            'cities': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'counties'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalog.City']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'catalog.datatype': {
