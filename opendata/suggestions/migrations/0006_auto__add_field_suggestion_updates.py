...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Suggestion.updates'
        db.add_column(u'suggestions_suggestion', 'updates',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.UpdateFrequency'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.updates'
        db.delete_column(u'suggestions_suggestion', 'updates_id')
    ...
    models = {
        ...
        u'suggestions.suggestion': {
            ...
            'data_format': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalog.UrlType']", 'null': 'True', 'blank': 'True'}),
