...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'suggestions_suggestion', 'data_format',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.UrlType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.data_format'
        db.delete_column(u'suggestions_suggestion', 'data_format_id')
