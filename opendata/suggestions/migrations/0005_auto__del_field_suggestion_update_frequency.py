...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Suggestion.update_frequency'
        db.delete_column(u'suggestions_suggestion', 'update_frequency')


    def backwards(self, orm):
        # Adding field 'Suggestion.update_frequency'
        db.add_column(u'suggestions_suggestion', 'update_frequency',
